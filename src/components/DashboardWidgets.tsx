...
export function KPISentimentWidget({ clients, metrics }: WidgetProps) {
  ...
  return (
    <Card className="h-full border-t-4 border-t-primary shadow-sm hover:shadow-planin-hover transition-all duration-300">
...
export function KPIEngagementWidget({ clients, metrics }: WidgetProps) {
  ...
  return (
    <Card className="h-full border-t-4 border-t-accent shadow-sm hover:shadow-planin-hover transition-all duration-300">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
          Taxa de Engajamento
        </CardTitle>
...
export function KPIPostsWidget({ clients, posts }: WidgetProps) {
  ...
  return (
    <Card className="h-full border-t-4 border-t-purple-500 shadow-sm hover:shadow-planin-hover transition-all duration-300">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
          Posts Coletados
        </CardTitle>
...
export function KPICompetitorsWidget({ clients }: WidgetProps) {
  ...
  return (
    <Card className="h-full border-t-4 border-t-orange-500 shadow-sm hover:shadow-planin-hover transition-all duration-300">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
          Concorrentes
        </CardTitle>
  ...
  return (
    <Card className="col-span-1 h-full flex flex-col">
      <CardHeader>
        ...
        <CardDescription>
          Presença de mercado baseada em volume.
        </CardDescription>
      </CardHeader>
      <CardContent className="flex-1 min-h-0">
        <ChartContainer
          ...
          {negativePosts.length > 0 ? (
            negativePosts.map((post) => {
              ...
              return (
                <div
                  key={post.id}
                  className="flex flex-col gap-2 p-3 border border-red-100 rounded-lg bg-red-50/30 hover:bg-red-50 transition-colors"
                >
